...
export type ExpenseCategory = 'housing' | 'food' | 'transport' | 'trips' | 'savings' | 'other'
export const EXPENSE_CATEGORIES: ExpenseCategory[] = ['housing', 'food', 'transport', 'trips', 'savings', 'other']
