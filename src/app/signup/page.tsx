    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4 bg-background">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 80% 50% at 50% -10%, hsl(258 90% 66% / 0.12), transparent)',
          }}
        />
        <div className="w-full max-w-sm relative text-center space-y-4">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-primary/10 border border-primary/20 text-2xl">
            📬
          </div>
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <div className="w-full max-w-sm relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Start tracking your growth</p>
        </div>
